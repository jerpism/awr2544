...
#define CPLX_SAMPLE_SIZE sizeof(uint32_t)
#define DOPPLER_ROWS    128
#define DOPPLER_COLUMNS 128
#define DOPPLER_MATRIX_SIZE     (DOPPLER_ROWS * DOPPLER_COLUMNS * NUM_RX_ANTENNAS)
#define DOPPLER_MATRIX_DATASIZE (DOPPLER_MATRIX_SIZE * sizeof(uint32_t))
